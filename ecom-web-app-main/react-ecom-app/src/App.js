    ...
    <div>
      ...
      <section className="p-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { id: 1, title: "Smartphone X", price: "₹49,999", img: "https://via.placeholder.com/300x200" },
            { id: 2, title: "Wireless Headphones", price: "₹3,499", img: "https://via.placeholder.com/300x200" },
            { id: 3, title: "Smartwatch Pro", price: "₹9,999", img: "https://via.placeholder.com/300x200" },
          ].map(product => (
